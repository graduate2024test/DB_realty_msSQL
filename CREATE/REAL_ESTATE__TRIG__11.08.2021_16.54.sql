...
--INSTEAD OF INSERT
------------------------------------------
CREATE TRIGGER istead_of_insert_agency_trigger  
ON RealEstateAgencyTEST
INSTEAD OF INSERT   
AS   
PRINT 'No insertion'
...
INSERT RealEstateAgencyTEST (RealEstateAgencyInfo, RealEstateAgencyCommission)
	VALUES		('Fibonacho', 0.295)
GO


DROP TRIGGER istead_of_insert_agency_trigger
GO
...
DROP TRIGGER istead_of_update_agency_trigger
GO
